...
/**
 * 1. Assert that system_prompt in the output of subgraph is the same as input
 */
class SubgraphClarifyWithUserTest {

    @Test
    fun `Test system_prompt is the same`(): Unit = runBlocking {
        ...
        // FIXME: when testing subgraph, stateManager is invoked, should find mocking strategy for this
        ...
        val clarificationSubgraph by subgraphContext.subgraphClarifyWithUser({ "STUB" })
        ...
        clarificationSubgraph.execute(context, input = "NOT RELEVANT")
